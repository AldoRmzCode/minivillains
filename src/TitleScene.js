...
class TitleScene extends Phaser.Scene {
  ...
  create() {
    ...
    const pingServers = (sethtml = true) => {
      var servers = {
        "us1": "https://happyfor.live",
        "us2": "https://happyfor.live",
        "eu1": "https://happyfor.live"
      };
    ...
    this.done = false;
    this.text = this.add.text(this.canvas.width / 2, 0, "Minivillains", {
    ...
    const login = (secret) => {
      this.nameBox.getChildByName("btn").innerHTML = "Conectado..";
...
this.shopLoading = false;
    this.shopBtn = new ImgButton(this, 10, 10, "shopBtn", () => {
      ...
      if(this.nameBox.getChildByName("btn").innerHTML == "Conectado..") return;
          ...
          grecaptcha.ready(() => {
            grecaptcha.execute(CAPTCHASITE, { action: "login" }).then((thetoken) => {
              ...
              try {
                ...
                this.login.getChildByName("login").innerHTML = "Iniciando..";
